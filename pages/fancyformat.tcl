...
proc addtoc {zDoc} {
  # If the extension with the [parsehtml] command has not been built into
  # the Tcl interpreter, fail. (It needs to be built before loading.)
  if {[info commands parsehtml] == ""} {throw error "No parsehtml command."}
